...
let currentScreen = "start"; // "start" | "instr" | "scene1" | "scene2A" | "scene2B" | "endingGood" | "endingBad"
...
function draw() {
  ...
  else if (currentScreen === "scene2A") drawScene2A();
  else if (currentScreen === "scene2B") drawScene2B();
  else if (currentScreen === "endingGood") drawEndingGood();
  else if (currentScreen === "endingBad") drawEndingBad();
...
function mousePressed() {
  ...
  else if (currentScreen === "scene2A") scene2AMousePressed();
  else if (currentScreen === "scene2B") scene2BMousePressed();
  else if (currentScreen === "endingGood") endingGoodMousePressed?.();
  else if (currentScreen === "endingBad") endingBadMousePressed?.();
}
